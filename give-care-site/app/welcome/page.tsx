          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-5xl font-light text-amber-950 mb-4">
                Welcome! Check your phone
              </h1>

              <p className="text-lg text-amber-950/70 leading-relaxed">
                Thank you for subscribing to GiveCare. We've sent you a text message with instructions to complete your setup and get started with AI-powered caregiving support.
              </p>

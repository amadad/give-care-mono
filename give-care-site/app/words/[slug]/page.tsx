                ...
                {post.categories && post.categories.length > 0 && (
                  <div className="flex justify-center gap-2 mb-6">
                    {post.categories.slice(0, 3).map((category: string) => (
                      <span
                        key={category}
                        className="text-xs text-amber-950 uppercase tracking-widest px-3 py-1 rounded-full border border-amber-300 bg-white"
                      >
                        {category}
                      </span>
                    ))}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-3">
                    <button className="w-10 h-10 rounded-full bg-amber-50 hover:bg-amber-100 flex items-center justify-center text-amber-950 hover:text-amber-900 transition-colors">

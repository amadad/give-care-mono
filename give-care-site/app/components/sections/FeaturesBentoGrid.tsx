...
const features = [
  {
    ...
    description: "4 validated assessments show a number (0-100). Finally, proof when others don't see the weight.",
    icon: (
  ...
  },
  {
    ...
    description: "Resources matched to your specific needs—respite funding, local support groups, practical strategies. Not generic lists you have to filter yourself.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Sudden silence? Score changes? Shifting routines? We check in when you need it—before things escalate. You're not alone in watching for warning signs.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">

      ...
      <main className="flex-1 flex flex-col items-center w-full">
        ...
        <div className="container mx-auto px-4 py-16 max-w-3xl text-center">
          <div className="bg-warning/10 border border-warning/20 rounded-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-warning mb-4">Changed Your Mind?</h2>
            <p className="text-base-content/80 mb-6">
              You can still join our community and receive valuable caregiving insights and updates.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/#newsletter" className="btn btn-warning">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              <h3 className="font-semibold text-lg mb-2">Explore Resources</h3>

...
const FEDERAL_PROGRAMS: IntermediateRecord[] = [
  // EMOTIONAL WELLBEING (3)
  {
    ...
    description:
      '24/7 free and confidential support for people in distress. Trained crisis counselors available to help with emotional distress, suicide prevention, and mental health crises.',
    providerName: 'SAMHSA',
  ...
  },
  {
    ...
    description:
      '24/7 crisis counseling and emotional support for people experiencing distress related to natural or human-caused disasters.',
    providerName: 'SAMHSA',
  ...
  // PHYSICAL HEALTH (3)
  {
    title: 'Medicare Help',
    description:
      'Official U.S. government Medicare helpline for questions about coverage, enrollment, claims, and benefits. Speak with licensed agents.',
  ...
  },
  {
    ...
    description:
      'Nationwide service connecting older adults and caregivers to local Area Agencies on Aging and community-based services like transportation, meals, home care, and caregiver support.',
  ...
  },
  {
    ...
    description:
      'Comprehensive health care services for eligible Veterans including primary care, specialty care, mental health services, and long-term care. Caregiver support programs available.',
  ...
  // FINANCIAL CONCERNS (3)
  {
    ...
    description:
      'Free, unbiased Medicare counseling and assistance in every state. Helps with enrollment decisions, understanding coverage options, and resolving billing issues.',
    providerName: 'Administration for Community Living',
  ...
  },
  {
    ...
    description:
      'Retirement, disability, and survivor benefits. Includes Medicare enrollment assistance and Supplemental Security Income (SSI) for people with limited income.',
  ...
  },
  {
    ...
    description:
      'Search tool for federal benefit programs including housing assistance, food programs, disaster relief, grants, and more. Over 1,000 programs searchable by category.',
  ...
  // TIME MANAGEMENT (3)
  {
    ...
    description:
      'Helps caregivers locate respite services by state. Provides information on temporary relief care options including in-home, adult day, and overnight respite.',
  ...
  },
  {
    ...
    description:
      'Information, resources, and support for caregivers of Veterans. Programs include respite care, caregiver training, financial assistance (stipends for qualifying caregivers), and peer support.',
    providerName: 'Veterans Health Administration',
  ...
  },
  {
    ...
    description:
      "Evidence-based information on healthy aging, Alzheimer's disease and related dementias, caregiving strategies, and clinical trials. Free publications and fact sheets.",
  ...
  // SOCIAL SUPPORT (3)
  {
    ...
    description:
      "Free, confidential support and information for people living with Alzheimer's and other dementias, and their caregivers. Dementia specialists available 24/7. Translation services for 200+ languages.",
  ...
  },
  {
    ...
    description:
      'Education, services, research, and advocacy for family caregivers. Includes fact sheets, online support groups, policy information, and state-by-state resource guides.',
  ...
  },
  {
    ...
    description:
      "Nation's leading family caregiver organization. Provides peer support programs, education webinars, advocacy tools, and resources for family caregivers across all ages and conditions.",
...
export const importFederalPrograms = internalMutation({
  handler: async ctx => {
    ...
    const validRecords = normalizedResults.filter(r => r.record).map(r => r.record!)

    const failedNormalization = normalizedResults.filter(r => r.error)

    console.log(
      `[IMPORT] Normalized ${validRecords.length} records, ${failedNormalization.length} failed validation`
    )

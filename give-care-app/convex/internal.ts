 ...
 *
 * Note: Node-dependent actions (sendWelcomeSms, newsletterSignup, submit) are in internal.actions.ts
 * This file contains mutations/queries that don't require Node runtime.
 *
 * Includes:
...
// Note: sendWelcomeSms action moved to internal.actions.ts (requires Node runtime)
...
export const retrieveImportant = query({
  ...
  handler: async (ctx, { userId, minImportance = 7, limit = 5 }) => {
    const user = await ctx.db
      .query('users')
      .withIndex('by_externalId', (q) => q.eq('externalId', userId))
      .unique();
...
// NEWSLETTER
// ============================================================================
// Note: newsletterSignup action moved to internal.actions.ts (requires Node runtime)

// ============================================================================
// ASSESSMENT RESULTS
// ============================================================================
// Note: submit action moved to internal.actions.ts (requires Node runtime)
...
// ============================================================================
// RE-EXPORT NODE ACTIONS
// ============================================================================
// These actions require Node.js runtime and are defined in internal.actions.ts
// Re-exported here to maintain the same API surface (internal.internal.*)

export { sendWelcomeSms, newsletterSignup, submit } from './internal.actions';

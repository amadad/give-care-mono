...
const ZIP3_TO_STATE: Record<string, string> = {
  ...
  "205": "VA", "206": "MD", "207": "MD", "208": "MD", "209": "MD",
  "300": "FL", "301": "FL", "302": "FL", "303": "GA", "304": "GA",
  "305": "FL", "306": "FL", "307": "FL", "308": "FL", "309": "FL",
  "400": "KY", "401": "KY", "402": "KY", "403": "KY", "404": "IN",
  "405": "OH", "406": "KY", "407": "FL", "408": "FL", "409": "FL",
  "500": "IA", "501": "IA", "502": "IN", "503": "IA", "504": "IN",
  "600": "IL", "601": "IL", "602": "IL", "603": "IL", "604": "IL",
  "605": "IL", "606": "IL", "607": "IL", "608": "IL", "609": "IL",
  "700": "LA", "701": "LA", "702": "LA", "703": "TX", "704": "LA",
...
export const findResourcesGeoLite = query({
  ...
  handler: async (ctx, args): Promise<ResourceMatch[]> => {
    ...
    if (candidateAreas.length === 0 && state) {
      candidateAreas = allServiceAreas.filter(area =>
        area.type === "statewide" && area.geoCodes.includes(state)
      );
    }
    ...
    for (const programId of programIds) {
      ...
      for (const resource of resources) {
        ...
        const coverage = serviceArea?.type === "national" ? "national"
          : serviceArea?.type === "statewide" ? "state"
          : serviceArea?.type === "county" ? "county"
          : "zip";

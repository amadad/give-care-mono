...
export const seedEssentialResources = mutation({
  ...
  handler: async ctx => {
    ...
    const program1 = await ctx.db.insert('programs', {
      ...
      description:
        'Free confidential support for family caregivers. Connect with trained counselors 24/7.',
    ...
    const program2 = await ctx.db.insert('programs', {
      ...
      description:
        'Connects caregivers to local respite services. Find in-home care, adult day programs, and overnight facilities.',
    ...
    const program3 = await ctx.db.insert('programs', {
      ...
      description:
        'Free downloadable caregiving planning workbook. Helps organize medical info, legal documents, and care plans.',
    ...
    const program4 = await ctx.db.insert('programs', {
      ...
      description:
        'Free screening tool to find financial assistance programs caregivers may qualify for. Covers healthcare, food, utilities, housing.',
    ...
    const program5 = await ctx.db.insert('programs', {
      ...
      description:
        'Information, education, services, research, and advocacy for caregivers. State-by-state resource directory.',

    ...
    const interventions = [
      {
        ...
        content: 'Free, confidential crisis support via text message. Available 24/7. Trained crisis counselors respond within minutes. No judgment, no medical advice - just someone who cares.',
      ...
      },
      {
        ...
        content: 'Respite care provides temporary relief for caregivers. Options include in-home care, adult day centers, and short-term residential facilities. Use ARCH National Respite Network to find local providers.',
      ...
      },
      {
        ...
        content: 'Financial assistance for caregivers includes: Medicare/Medicaid benefits, National Family Caregiver Support Program (NFCSP), state-specific programs, tax credits, and nonprofit grants. Contact your local Area Agency on Aging (AAA) for eligibility.',
      ...
      },
      {
        ...
        content: 'Use the Caregiver Action Network Daily Task Organizer to: (1) List all caregiving tasks, (2) Prioritize by urgency, (3) Delegate what you can, (4) Schedule breaks, (5) Track medications and appointments. Available as free PDF or app.',
      ...
      },
      {
        ...
        content: 'In-person and virtual support groups provide emotional support, practical tips, and community. Find groups through: Family Caregiver Alliance, AARP, Alzheimer\'s Association, hospital social workers, and religious organizations. Most are free.',

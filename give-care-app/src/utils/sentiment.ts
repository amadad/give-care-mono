...
/**
 * Classify overall sentiment of user message
 * Returns: "positive" | "negative" | "neutral"
 */
export function classifySentiment(
  message: string
): "positive" | "negative" | "neutral" {
  if (containsGratitude(message) || indicatesActionTaken(message)) {
    return "positive";
  }

  if (containsFrustration(message) || containsConfusion(message)) {
    return "negative";
  }

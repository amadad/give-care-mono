...
import { checkWellnessStatus, findInterventions, updateProfile, startAssessment, recordAssessmentAnswer, setWellnessSchedule, recordMemory, findLocalResources } from "./tools";
...
export const giveCareAgent = new Agent<GiveCareContext>({
  ...
  tools: [checkWellnessStatus, findInterventions, updateProfile, startAssessment, setWellnessSchedule, recordMemory, findLocalResources],
...
export async function runAgentTurn(
  ...
  try {
    ...
    return {
      message:
        "I'm having trouble connecting right now. For immediate support, call 988 💙",

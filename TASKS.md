...
- **Product Features**: `give-care-app/docs/FEATURES.md` (non-technical, user-focused)
- **Technical Architecture**: `give-care-app/docs/ARCHITECTURE.md` (technical reference)
- **Development Guide**: `CLAUDE.md` (monorepo patterns)
- **Agent Guidelines**: `AGENTS.md` (AI agent development rules)

          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-lg">
                ...
                <h3 className="font-heading text-xl">{stat.title}</h3>
              </div>
              <div className="flex-grow flex flex-col justify-center">
                <div className="font-heading text-4xl font-bold mb-md leading-tight">
                  {stat.bigText}
                </div>
                <p className="font-body text-md leading-relaxed mb-lg">
                  {stat.smallText}
                </p>
              </div>
              <a 
                ...
                className="font-body text-sm hover:underline inline-flex items-center mt-2 self-end"
